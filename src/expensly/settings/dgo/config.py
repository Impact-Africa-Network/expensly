...
DEFAULT_FILE_STORAGE = "expensly.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "expensly.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "expensly.settings.dgo.utils.MediaRootS3BotoStorage"
